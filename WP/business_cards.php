...
<div class="business-page">
    ...
    <nav class="nav-princip">
        ...
        <div class="menu-desktop">
            <ul>
                ...
                <li><a href="<?php echo esc_url(home_url('/about')); ?>">ABOUT US</a></li>
                <li><a class="current" href="<?php echo esc_url(home_url('/business-card')); ?>">BUSINESS CARD</a></li>
    ...
    <div class="business-photos">
        ...
        $images = get_field('cards');


        if( $images ): ?>
        <?php foreach( $images as $image ): ?>

        <div class="img-card"><img src="<?php echo esc_url($image['sizes']['large']); ?>" alt=""></div>
<!--        <div class="img-card"><img src="images/card_white.png" alt=""></div>-->
